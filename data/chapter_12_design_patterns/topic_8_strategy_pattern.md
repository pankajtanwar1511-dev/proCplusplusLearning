...
**Answer:** Null pointer dereference if operation not set

**Explanation:** Function pointer may be null. Calling null function pointer causes crash.

**Fix:** Check for null or require operation in constructor

**Key Concept:** #null_pointer #initialization

</details>

---

(Practice questions Q2-Q20 continue with code analysis covering strategy patterns)
